...
I dont know why but this program takes a while to compile with the Makefile but it  will get there


Questions:

1. The problem of producer consumer is solved using __Semaphores__. - 1 point
	a. Mutex Locks
	b. Semaphores

2. What two functions defined in Java are used for synchronization between producer and consumers in your program? __notify()__ and __wait()__. - 2 points

3. In which function do you override the body to define the new body of a thread in java? ___run___. - 1 point
